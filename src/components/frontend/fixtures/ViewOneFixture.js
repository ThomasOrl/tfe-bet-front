...
function ViewOneFixtureData(){
    ...
    if(loading){
        ...
        return (
                        ...
                        <div className="card-body">
                            <table className="table table-bordered text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <button  onClick={()=> {setOpenModale(true);}} className="btn btn-warning">{odds.home}</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="scoreExt">0</td>
                                        <td>
                                            <button id="counter" onClick={() => setStartCount(true)} className="btn btn-success m-1">{seconds > 0 ? seconds : "Start"}</button>
            ...
            <>
                {openModale && <Modale closeModale={setOpenModale}>
                </Modale>
                }
            </>
            </>    
